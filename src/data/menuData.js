export const menuData = {
    en: [
        ...
        },
        {
            id: "des9-specials",
            title: "DES9 Specials",
            categoryImage: "/images/cat_des9_specials.png",
            items: [
                { name: "Selam", price: "500.00", image: "/images/des9-logo.jpg", description: "Senber, Quanta, Dulet, Tibs (Portion for 1)" },
                { name: "Fikir", price: "700.00", image: "/images/des9-logo.jpg", description: "Dulet, Quanta, Enkulal, Gomen, Ayib (Portion for 2)" },
                { name: "Andinet", price: "950.00", image: "/images/des9-logo.jpg", description: "Tibs, Senber, Quanta, Dulet, Gomen, Ayib, Enkulal, Siga Firfir (Portion for 3)" }
            ]
        },
        {
            id: "bar-specials",
            ...
            items: [
                { name: "DES9 Signature Drink", price: "", image: "/images/des9-logo.jpg", description: "🍸 DES9 Purple Cocktail" },
                { name: "Beer Bucket", price: "", image: "/images/des9-logo.jpg", description: "🍺 5 Beer Special Offer" },
                { name: "VIP Bottle Service", price: "", image: "/images/des9-logo.jpg", description: "🥃 Whisky bottle for table" }
            ]
        },
        {
            id: "soft-drinks",
    ...
    am: [
        ...
        },
        {
            ...
            categoryImage: "/images/cat_des9_specials.png",
            items: [
                { name: "ሠላም", price: "500.00", image: "/images/des9-logo.jpg", description: "(ሰንበር, ቆንጣ, ዱለት, ጥብስ) (ባለ 1)" },
                { name: "ፍቅር", price: "700.00", image: "/images/des9-logo.jpg", description: "(ዱለት, ቋንጣ, እንቁላል, ጎመን, አይብ) (ባለ 2)" },
                { name: "አንድነት", price: "950.00", image: "/images/des9-logo.jpg", description: "(ጥብስ, ሰንበር, ቆንጣ, ዱለት, ጎመን, አይብ, እንቁላል ስጋ ፍርፍር) (ባለ 3)" }
            ]
        },
        {
            id: "bar-specials",
            ...
            categoryImage: "/images/bar special.jpg",
            items: [
                { name: "የደስ፱ ልዩ መጠጥ", price: "", image: "/images/des9-logo.jpg", description: "🍸 የደስ፱ ፓርፕል ኮክቴል" },
                { name: "የቢራ ፓኬጅ", price: "", image: "/images/des9-logo.jpg", description: "🍺 የ5 ቢራ ልዩ ቅናሽ" },
                { name: "ቪአይፒ የጠርሙስ አገልግሎት", price: "", image: "/images/des9-logo.jpg", description: "🥃 የዊስኪ ጠርሙስ ለጠረጴዛ" }
            ]
        },
        {
            id: "soft-drinks",
